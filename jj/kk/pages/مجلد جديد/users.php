...
$type = isset($_GET['type']) ? sanitize($_GET['type']) : 'all'; // Add type parameter
...
<div class="user-section">
    <div class="container py-4">
        <div class="page-header d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 text-dark fw-bold"><i class="fas fa-users me-2 text-primary"></i><?php echo $page_title; ?></h2>
            <a href="index.php?page=add-user" class="btn btn-primary d-flex align-items-center">
                <i class="fas fa-plus me-2"></i> Add New <?php echo $type === 'customer' ? 'Customer' : ($type === 'employee' ? 'Employee' : 'User'); ?>
            </a>
        </div>
